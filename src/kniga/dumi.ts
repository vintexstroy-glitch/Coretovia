...
/** същото за листа Продажби · двайсетте му глави, после Ключ (U) */
export const KLYUCH_KOLONA_PRODAZHBI = 21;
/** редът със сборовете под всяка от двете му таблици · неговите A58 и A77 */
export const OBSHTO_EVRO = 'ОБЩО евро';
...
export const DUMI_ZA_OTCHETITE =
  'Коефициентите и диаграмите за избрания период ЧАКАТ свой резен · дотогава редът стои празен, за да не мръдне нито един негов адрес.';
