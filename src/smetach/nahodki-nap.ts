 ...
 * право там. Растежът на проверките от Настройки ЧАКА негова дума кои са
 * „всякакви засичания от практиката" (ADR-007 §6) и дотогава списъкът е тук,
 * изброен поименно (правило 12: липсващото се казва).
 */
