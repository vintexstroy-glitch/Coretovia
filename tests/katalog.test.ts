...
describe('каталогът', () => {
  it('двайсет и три команди · уникални ключове · `prozorets.glagol`', () => {
    expect(KATALOG).toHaveLength(23);
    const klyuchove = KATALOG.map((k) => k.klyuch);
    expect(new Set(klyuchove).size).toBe(23);
