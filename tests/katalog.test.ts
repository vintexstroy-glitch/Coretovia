...
describe('каталогът', () => {
  it('двайсет и една команди · уникални ключове · `prozorets.glagol`', () => {
    expect(KATALOG).toHaveLength(21);
    const klyuchove = KATALOG.map((k) => k.klyuch);
    expect(new Set(klyuchove).size).toBe(21);
