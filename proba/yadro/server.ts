...
// 4180, не 4178: старият проект (MasterBook) държи 4178 и негов проход, оставен
// да върви, би подал ЧУЖДА страница на нашия — точно това стана при първото
// пускане: проходът на Coretovia видя екрана за вход на MasterBook.
export const PORT = Number(process.env['PROBA_PORT'] ?? 4180);
